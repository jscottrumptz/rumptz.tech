        ...
        <nav className="bg-gray-800">
                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        ...
                        <div className="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                            ...
                            <a href="#"
                               className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Availability</a>
                        </div>
                    </div>
            ...
            <div className="md:hidden" id="mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <a href="#"
                       className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Availability</a>
